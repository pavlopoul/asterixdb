...
public class DatasetTupleTranslator extends AbstractTupleTranslator<Dataset> {
    ...
    protected Dataset createDatasetFromARecord(ARecord datasetRecord) throws HyracksDataException {
        ...
        return new Dataset(dataverseName, datasetName, /*fieldName,*/ typeDataverseName, typeName,
                metaTypeDataverseName, metaTypeName, nodeGroupName, compactionPolicy, compactionPolicyProperties,
                datasetDetails, hints, datasetType, datasetId, pendingOp, rebalanceCount);
    }
